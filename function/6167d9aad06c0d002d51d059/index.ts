...
export async function testIndex() {
	...
	// await db.collection('bucket_61e562230cffb9002d35cabe').createIndex({ "user": 1 });
	// await db.collection('bucket_61e562230cffb9002d35cabe').createIndex({ "point": 1, "user": 1 });
	await db.collection('bucket_61e562230cffb9002d35cabe').dropIndex({ "point": 1 });
